    ...
    <div class="card-body p-4">
      <div class="d-flex justify-content-between align-items-center mb-3">
        <h5 class="fw-bolder m-0">
          <i class="ti ti-calendar-time me-2"></i>Jadwal Perencanaan
        </h5>
        <span class="badge bg-primary bg-opacity-10 text-primary">
          <i class="ti ti-user me-1"></i>Pegawai
        </span>
      </div>
      <hr class="mb-2">
      ...
      <div class="timeline-wrapper mb-4">
        ...
        <div class="d-flex align-items-center">
          ...
          <div>
            ...
            <small class="text-muted">{{ $jadwalPerencanaan['waktuSelesai']->translatedFormat('d F Y, H:i') }}</small>
          </div>
        </div>
      </div>
      ...
      <div class="d-grid gap-0">
        ...
        <a href="{{ route('rencana_pembelajaran.create') }}" class="btn btn-success">
          <i class="ti ti-pencil me-2"></i> Buat Rencana Sekarang
        </a>
        ...
        <button class="btn btn-dark btn-lg d-flex align-items-center justify-content-center" disabled>
          ...
          <span class="fs-3">{{ $jadwalPerencanaan['sisaHari'] > 0 ? 'Belum Waktunya' : 'Masa Perencanaan Telah
            Berakhir' }}</span>
        </button>
        @endif
      </div>
