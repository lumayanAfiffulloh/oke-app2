    ...
    <tbody>
      ...
      <tr>
        ...
        <td class="px-2">
          ...
          @if($rencanaPembelajaran->kelompokCanValidating &&
        ...
        <td class="px-2">
          ...
          <span class="badge {{ 
              $rencanaPembelajaran->kelompokCanValidating->status_revisi == 'belum_direvisi' ? 'text-bg-danger' : 
              ($rencanaPembelajaran->kelompokCanValidating->status_revisi == 'sedang_direvisi' ? 'text-bg-warning' : 'text-bg-success') 
            }} fs-1 p-1">
        ...
        <td class="px-2">
          ...
          <div class="modal fade" id="setujuiModal-{{ $rencanaPembelajaran->id }}" tabindex="-1"
            ...
            <div class="modal-dialog">
              <div class="modal-content">
                ...
                <div class="modal-body border border-2 mx-3 rounded-2">
                  <form action="{{ route('rencana.setujuiDariRevisi', $rencanaPembelajaran->id) }}" method="POST"
          ...
          @else
          <div class="fw-bold">*Revisi rencana pembelajaran belum dikirim.</div>
          @endif
        </td>
      </tr>
      @endforeach
