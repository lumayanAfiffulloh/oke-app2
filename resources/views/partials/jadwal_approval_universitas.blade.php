  ...
  <div class="timeline-wrapper mb-4">
    ...
    <div class="d-flex align-items-center">
      ...
      <div>
        ...
        <small class="text-muted">{{ $jadwalApproval['waktuSelesai']->translatedFormat('d F Y, H:i') }}</small>
      </div>
    </div>
  </div>
