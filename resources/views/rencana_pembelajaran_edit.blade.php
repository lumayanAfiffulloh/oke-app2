    ...
    <div class="card mb-3 bg-white">
        <div class="card-body p-0 ">
            ...
            <div class="form-group mt-1 mb-3">
                ...
                <div class="col-md-2">
            <input type="number" min="2024" max="2099" step="1" value="{{ old('tahun') ?? $rencanaPembelajaran->tahun }}" class="form-control @error('tahun') is-invalid @enderror" id="tahun" name="tahun">
                </div>
            ...
            <div class="form-group mt-1 mb-3 col-md-4">
                ...
                <div class="input-group">
                    ...
                    <input type="number" min="0" value="{{ old('anggaran') ?? $rencanaPembelajaran->anggaran }}" step="1000" class="form-control @error('anggaran') is-invalid @enderror"  id="anggaran" name="anggaran" >
                </div>
            ...
            <div class="d-flex justify-content-start mt-2">
                <form action="/rencana_pembelajaran" method="POST">
                    @csrf
                ...
                <a name="" id="" class="btn btn-warning me-1 tw-transition tw-ease-in-out tw-delay-10 hover:tw-translate-y-0 hover:tw-scale-110 hover:tw-bg-amber-500 tw-duration-200" href="/rencana_pembelajaran">BATAL EDIT</a>
