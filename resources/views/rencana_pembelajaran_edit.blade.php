...
<div class="card mb-3 bg-white">
	<div class="card-body p-0 ">
		<div class="card-header p-3 fs-5 fw-bolder" style="background-color: #ececec;">
			...
			Edit Rencana Pembelajaran <span class="fw-bolder tw-text-blue-500">{{ $rencanaPembelajaran->id }}</span>
		</div>
		<form action="/rencana_pembelajaran/{{ $rencanaPembelajaran->id }}" method="POST" class="px-3 py-3" id="formID">
			...
			<div class="form-group mt-1 mb-3">
				...
				<div class="col-md-2">
					<input type="number" min="2024" max="2055" step="1" value="{{ old('tahun') ?? $rencanaPembelajaran->tahun }}"
			...
			<div class="form-group mt-1 mb-3">
				...
				<div class="form-check form-check-inline">
					<input class="form-check-input" type="radio" name="klasifikasi" id="pendidikan" value="pendidikan" {{
						old('klasifikasi') ?? $rencanaPembelajaran->klasifikasi === 'pendidikan' ? 'checked' : '' }}
					onclick="updateCategoryOptions()">
				...
				<div class="form-check form-check-inline">
					<input class="form-check-input" type="radio" name="klasifikasi" id="pelatihan" value="pelatihan" {{
						old('klasifikasi') ?? $rencanaPembelajaran->klasifikasi === 'pelatihan' ? 'checked' : '' }}
					onclick="updateCategoryOptions()">
			...
			<div class="form-group mt-1 mb-3">
				...
				<div class="col-md-6">
					<select class="form-select" id="kategori" name="kategori">
						...
						<option value="pendidikan" {{ old('kategori') ?? $rencanaPembelajaran->kategori === 'pendidikan' ?
							'selected' : '' }} id="kategori-pendidikan">Pendidikan</option>
						<option value="klasikal" {{ old('kategori') ?? $rencanaPembelajaran->kategori === 'klasikal' ? 'selected' :
							'' }} id="kategori-klasikal">Klasikal</option>
						<option value="non-klasikal" {{ old('kategori') ?? $rencanaPembelajaran->kategori === 'non-klasikal' ?
							'selected' : '' }} id="kategori-non-klasikal">Non-Klasikal</option>
					</select>
			...
			{{-- BENTUK JALUR --}}
			<div class="form-group mt-1 mb-3">
				<label for="bentuk_jalur" class="fw-semibold">Bentuk Jalur</label>
				<div class="col">
					<input type="text" class="form-control @error('bentuk_jalur') is-invalid @enderror  " id="bentuk_jalur"
						name="bentuk_jalur" value="{{ old('bentuk_jalur') ?? $rencanaPembelajaran->bentuk_jalur}}">
				</div>
			...
			<div class="form-group mt-1 mb-3">
				...
				<div class="col">
					<input type="text" class="form-control @error('nama_pelatihan') is-invalid @enderror" id="nama_pelatihan"
						name="nama_pelatihan" value="{{ old('nama_pelatihan') ?? $rencanaPembelajaran->nama_pelatihan}}">
				</div>
			...
			<div class="form-group mt-1 mb-3">
				...
				<div class="col-md-2">
					<input type="number" min="1" max="50" step="1"
						value="{{ old('jam_pelajaran') ?? $rencanaPembelajaran->jam_pelajaran }}"
			...
			<div class="form-group mt-1 mb-3">
				...
				<div class="form-check form-check-inline">
					<input class="form-check-input" type="radio" name="regional" id="nasional" value="nasional" {{ old('regional')
						?? $rencanaPembelajaran->regional === 'nasional' ? 'checked' : '' }}>
				...
				<div class="form-check form-check-inline">
					<input class="form-check-input" type="radio" name="regional" id="internasional" value="internasional" {{
						old('regional') ?? $rencanaPembelajaran->regional === 'internasional' ? 'checked' : '' }}>
			...
			<div class="form-group mt-1 mb-3 col-md-4">
				...
				<div class="input-group">
					...
					<input type="number" min="0" value="{{ old('anggaran') ?? $rencanaPembelajaran->anggaran }}" step="1000"
			...
			<div class="form-group mt-1 mb-3">
				...
				<div class="btn-group" role="group" aria-label="Default button group">
					<input class="btn-check" type="radio" name="prioritas" id="rendah" value="rendah" {{ old('prioritas') ??
						$rencanaPembelajaran->prioritas === 'rendah' ? 'checked' : '' }} autocomplete="off" >
					...
					<input class="btn-check" type="radio" name="prioritas" id="sedang" value="sedang" {{ old('prioritas') ??
						$rencanaPembelajaran->prioritas === 'sedang' ? 'checked' : '' }} autocomplete="off">
					...
					<input class="btn-check" type="radio" name="prioritas" id="tinggi" value="tinggi" {{ old('prioritas') ??
						$rencanaPembelajaran->prioritas === 'tinggi' ? 'checked' : '' }} autocomplete="off">
