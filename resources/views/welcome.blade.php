        ...
        <div class="row min-vh-100 align-items-center">
            ...
            <div class="col-lg-7" style="padding-right: 10%">
                <div>
                    ...
                    <span class="display-5 text-primary fw-bolder">SANTI</span>
                    <hr class="border-primary" style="border-width : 2px">
                    <p class="fs-4 mt-1">SANTI, atau Sistem Informasi Perencanaan Pengembangan Kompetensi, dikembangkan
                        oleh DSDM Undip untuk memfasilitasi perencanaan, pemantauan, dan evaluasi pengembangan
                        kompetensi pegawai di Universitas Diponegoro.</p>
                    <div class="mt-2">
