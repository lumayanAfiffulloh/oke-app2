				...
				<form action="{{ route('update-whatsapp-link') }}" method="POST">
					...
					<div class="input-group">
						...
						<input type="url" name="whatsapp_link" class="form-control" placeholder="https://chat.whatsapp.com/..."
							value="{{ $kelompok->link_grup_whatsapp ?? '' }}" pattern="https://chat\.whatsapp\.com/.+" required>
					...
					<div class="d-flex align-items-center mt-2">
						<a href="{{ $kelompok->link_grup_whatsapp }}" target="_blank" class="btn btn-sm btn-outline-success me-2">
