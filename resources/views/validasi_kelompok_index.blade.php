@extends('layouts.app_modern', ['title' => 'Validasi Rencana Pembelajaran Kelompok'])
@section('content')
<div class="card mb-4 pb-4 bg-white">
	<div class="card-body px-0 py-0">
		...
		<ul class="nav nav-tabs mt-2 px-2" id="statusTabs">
			...
			<li class="nav-item">
				<a class="nav-link fw-semibold" data-bs-toggle="tab" href="#direvisi">Revisi</a>
			</li>
			<li class="nav-item">
				<a class="nav-link fw-semibold active" data-bs-toggle="tab" href="#belumdivalidasi">Belum Divalidasi</a>
			</li>
		</ul>
