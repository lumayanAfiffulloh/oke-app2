        ...
        <div class="form-group mt-1 mb-3">
          ...
          <div class="form-check form-check-inline">
            <input class="form-check-input @error('jenjang') is-invalid @enderror" type="checkbox" name="jenjang[]"
              id="D1" value="D1" {{ is_array(old('jenjang')) && in_array('D1', old('jenjang')) ? 'checked' : '' }}>
            <label class="form-check-label" for="D1">D1</label>
          </div>
          <div class="form-check form-check-inline">
            <input class="form-check-input @error('jenjang') is-invalid @enderror" type="checkbox" name="jenjang[]"
              id="D2" value="D2" {{ is_array(old('jenjang')) && in_array('D2', old('jenjang')) ? 'checked' : '' }}>
            <label class="form-check-label" for="D2">D2</label>
          </div>
          <div class="form-check form-check-inline">
            <input class="form-check-input @error('jenjang') is-invalid @enderror" type="checkbox" name="jenjang[]"
              id="D3" value="D3" {{ is_array(old('jenjang')) && in_array('D3', old('jenjang')) ? 'checked' : '' }}>
            <label class="form-check-label" for="D3">D3</label>
          </div>
          <div class="form-check form-check-inline">
            <input class="form-check-input @error('jenjang') is-invalid @enderror" type="checkbox" name="jenjang[]"
              id="S1" value="S1" {{ is_array(old('jenjang')) && in_array('S1', old('jenjang')) ? 'checked' : '' }}>
            <label class="form-check-label" for="S1">S1/D4</label>
          </div>
          <div class="form-check form-check-inline">
            <input class="form-check-input @error('jenjang') is-invalid @enderror" type="checkbox" name="jenjang[]"
              id="S2" value="S2" {{ is_array(old('jenjang')) && in_array('S2', old('jenjang')) ? 'checked' : '' }}>
            <label class="form-check-label" for="S2">S2</label>
          </div>
          <div class="form-check form-check-inline">
            <input class="form-check-input @error('jenjang') is-invalid @enderror" type="checkbox" name="jenjang[]"
              id="S3" value="S3" {{ is_array(old('jenjang')) && in_array('S3', old('jenjang')) ? 'checked' : '' }}>
