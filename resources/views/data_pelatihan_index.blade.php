		...
		<div class="card-body px-0 pt-0">
			...
			<div class="row my-3">
				<div class="col-6">
					...
					<button class="position-relative ">
						<a href="/bentuk_jalur"
							class="btn btn-outline-warning ms-sm-1"
							style="font-size: 0.9rem">
							<span class="me-1">
							...
							<tr>
								...
								<td>
									<div class="btn-group" role="group">
										...
										<a href="/data_pelatihan/{{ $item->id }}/edit" class="btn btn-warning btn-sm" style="font-size: 0.8rem">Edit</a>
